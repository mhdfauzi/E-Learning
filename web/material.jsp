...
<script>
    ...
    <br>
        ...
        <form enctype="multipart/form-data" action="uploadmaterial.jsp" onsubmit="return verify()" method="post">
        ...
        <table style="margin:20px auto;" border="1" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <tr><th>File Name</th>
                    ...
                    <th>Upload Time</th>
            <%
                ResultSet rs = koneksi.getResultFromSqlQuery1("select doc_id,filename,type, upload_time, upload_by from material");
                int count =0;
                while(rs.next())
                {
                   out.println("<tr>"
