...
<!-- Navbar -->
  ...
  <center><h1>Data of Students</h1></center>
  <table style="margin:20px auto;" border="1">
	<tr>
        ...
        <tr>
            ...
            <td>
                <a href="UserController?proses=edit-student&nim=<%=data.get(x).getNim()%>">Edit</a>
                <a href="UserController?proses=hapus-student&nim=<%=data.get(x).getNim()%>">Delete</a>
            </td>
        </tr>
        <%}%>
    </table>
    ...
    <center>
    <a class="tambah" href="UserController?proses=input-student">Add</a>
    </center>
