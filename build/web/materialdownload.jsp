        ...
        <table style="margin:20px auto;" border="1" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <tr><th>File Name</th>
                    ...
                    <th>Action</th></tr>
            <%
                ResultSet rs = koneksi.getResultFromSqlQuery("select doc_id,filename,type, upload_time, upload_by from material");
                int count =0;
                while(rs.next())
                {
                   out.println("<tr>"
                           ...
                           + "<td><a href='downloadmaterial.jsp?Doc_id="+rs.getInt(1) +"'> Download </a></td>"                                                      
                           + "</tr>");
                   count++;
                }
                rs.close();
